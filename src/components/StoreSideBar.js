    ...
    <div>
            ...
            <aside className="flex flex-col w-full h-screen px-4 py-8 overflow-y-auto dark:bg-gray-900 dark:border-gray-700 ">
                ...
                <div className="flex flex-col items-center mt-2 -mx-2">
                    ...
                    <h4 className="mx-2 mt-10 font-medium text-gray-800 dark:text-gray-200">Manoj Dasanayake</h4>
                    <p className="mx-2 mt-1 text-sm font-medium text-gray-600 dark:text-gray-400">manojs@gmail.com</p>
                </div>
