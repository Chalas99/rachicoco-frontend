...
>
  ...
  <div class="mt-2 md:mx-6 text-left">
                    <div>
                        <p class="text-xl font-medium tracking-tight text-gray-800">Ema Watson</p>
                        <p class="text-orange-500 ">Marketing Manager at Stech</p>
                    </div>

                    <p class="mt-4 text-lg leading-relaxed text-gray-800 md:text-xl"> “Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore quibusdam ducimus libero ad tempora doloribus expedita laborum saepe voluptas perferendis delectus assumenda”.</p>
