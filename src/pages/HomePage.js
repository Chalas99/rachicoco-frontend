       ...
       <div className="w-full mt-16 bg-center bg-cover  h-[35rem]" style={{ backgroundImage: `url(${tree})` }}>
        <div className="flex items-center justify-center w-full h-full bg-gray-900/40">
          <div className="text-center">
            ...
            <button className="w-full px-5 py-2 mt-4 text-sm font-medium text-white transition-colors duration-300 transform bg-orange-600 rounded-md lg:w-auto hover:bg-orange-500 focus:outline-none focus:bg-orange-500"><a href='/Gallery'>Order now</a></button>
          </div>
        </div>
      </div>
