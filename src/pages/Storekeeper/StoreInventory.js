        ...
        <div className='flex'>
            ...
            <div className="mx-4 w-4/5 mt-20 ">
                ...
                <div className="flex">
                    ...
                    <h2 className="text-3xl font-medium text-orange-500">Inventory</h2>
                    </div>
                    <div className='flex w-full justify-end'>
                        ...
                        {/* <div>
                        <button class="relative inline-block w-32 h-10 my-5 overflow-hidden border-2 border-purple-900 transition-colors duration-500 rounded-md font-medium text-purple-900 bg-purple-900 hover:text-white">
                        hover me 
                        <span class="absolute z-0 inset-0 bg-purple-900 rounded-full"></span>
                        </button>
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200 ">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200  ">
                                            <tr>
                                                ...
                                                <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                <div className="flex items-center gap-x-3">
                                                        <span>5 piece pack</span>
                                                </div>
                                                </td>
                                                <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                <div className="flex items-center gap-x-3">
                                                        <span>10 packs in process</span>
                                                </div>
                                                </td>
